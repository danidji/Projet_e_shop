...
export default function BasketTotal(props) {
    ...
    function getVoucher() {
        ...
        if (context.setVoucherRate(state.inputValue) && !state.useVoucherRate) {
            ...
            setState({ ...state, totalPrice: newTotal, tva: getTva(newTotal), HTprice: newTotal - getTva(newTotal), useVoucherRate: true });
        ...
        //sinon je retourne le total normal    
            ...
            setState({ ...state, totalPrice: getTotal(), tva: getTva(getTotal()), HTprice: getTotal() - getTva(getTotal()) })
        }
    }
    ...
    return (
        ...
        <div className="basket_total">
            ...
            <VoucherRate onChange={handleChange} onClick={() => getVoucher()} val={state.inputValue} />
